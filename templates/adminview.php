...
<a href="https://docs.tornevall.net/x/AoA_/" target="_blank"><?php echo __(
    "About DNSBLv5",
    'tornevall-networks-dnsbl-implementation'
); ?></a><br>
<a href="https://tracker.tornevall.net/projects/DNSBLWP" target="_blank"><?php echo __(
    "DNSBLWP Issue tracker",
    'tornevall-networks-dnsbl-implementation'
); ?></a><br>
<a href="https://dnsbl.tornevall.org/removal/" target="_blank"><?php echo __(
    "How to get delisted",
    'tornevall-networks-dnsbl-implementation'
); ?></a><br>
...
<form method="post" action="options.php">
    ...
    if (!is_array($resolverNames) || (is_array($resolverNames) && !count($resolverNames)) || !in_array(
        'dnsbl.tornevall.org',
        $resolverNames
    ) || !$hasProperResolvers) {
        $resolverNames = [
    ...
    foreach ($currentFlags as $flag => $bitValue) {
        $flagListSelector[] = '<option value="' . $flag . '" ' . (in_array(
            $flag,
            $savedFlags
        ) ? 'selected=selected' : '') . '>' . htmlentities($flag) . ' [' . $bitValue . ']</option>';
    }
    ...
    <div style="border-top:1px dashed gray;margin-top:10px;margin-bottom: 5px;">
        ...
        <div style="font-weight: bold; font-size: 20px !important;margin-top:5px;margin-bottom:5px;"><?php echo __(
            'Plugin behaviour',
            'tornevall-networks-dnsbl-implementation'
        ); ?></div>
        ...
        <table width="80%" cellpadding="6" cellspacing="0" style="border: 1px solid black;">
            <tr>
                <td width="<?php echo $td['left']; ?>" valign="top"
                    style="font-weight: bold;"><?php echo __(
                        'Trigger on',
                        'tornevall-networks-dnsbl-implementation'
                    ) . " ..."; ?>
                </td>
                <td width="<?php echo $td['right']; ?>" valign="top">
                    ...
                    <a href="https://docs.tornevall.net/x/AoA_#DNSBLv5:AbouttheDNSBlacklistProjectandusage-RBLBitmaskingData"><?php echo __(
            ...
            <tr>
                <td>
                    ...
                    <i><?php echo __(
                        "Define for how long a blacklisted ip should be stored in local memory, defined in seconds (minimum allowed value is 900 sec=15 minutes)",
                        'tornevall-networks-dnsbl-implementation'
                    ); ?></i>
                </td>
                <td>
            ...
            <tr>
                ...
                <td width="<?php echo $td['right']; ?>" valign="top">
                    <input type="checkbox" <?php echo(get_option("tornevall_dnsbl_nocomment") ? "checked" : ""); ?>
                           value="1"
                           name="tornevall_dnsbl_nocomment"> <?php echo "... " . __(
                    ...
                    <input type="checkbox" <?php echo(get_option("tornevall_dnsbl_blockfull") ? "checked" : ""); ?>
                           value="1"
                           name="tornevall_dnsbl_blockfull"> <?php echo "... " . __(
                ...
                <tr>
                    ...
                    <td width="<?php echo $td['right']; ?>" valign="top">
                        <input type="checkbox" <?php echo(get_option("tornevall_dnsbl_delistingpage_comments_disabled") ? "checked" : ""); ?>
                               value="1"
                               name="tornevall_dnsbl_delistingpage_comments_disabled"> <?php echo __(
                ...
                <tr>
                    ...
                    <td width="<?php echo $td['right']; ?>" valign="top">
                        <input type="checkbox" <?php echo(get_option("tornevall_dnsbl_form_noajax") ? "checked" : ""); ?>
                               value="1"
                               name="tornevall_dnsbl_form_noajax"> <?php echo __(
        ...
        <table width="80%" cellpadding="6" cellspacing="0" style="border: 1px solid black;" id="dnsblApiView">
            <tr>
                ...
                <td width="<?php echo $td['right']; ?>" valign="top">
                    <button type="button" onclick="runApiTest('test')"><?php echo __(
                        'Test API functionality',
                        'tornevall-networks-dnsbl-implementation'
                    ); ?></button>
                    <button type="button"
                            onclick="runApiTest('flags')"><?php echo __(
                                'Update above flag list (no credentials required)',
                                'tornevall-networks-dnsbl-implementation'
                            ); ?></button>
                    <div style="font-style: italic;"><?php echo __(
                ...
                <td width="<?php echo $td['right']; ?>" valign="top">
                    ...
                    if (is_array($dnsblPermissionArray) && count($dnsblPermissionArray)) {
                        echo '
                                ...
                                <div style="color:#009900;font-weight: bold;">' . implode(
                            "<br>\n",
                            $dnsblPermissionArray
                        ) . '</div>';
                    }
                    echo '
                                <div style="color:#990033;font-weight: bold;font-size:11px;cursor: pointer;margin-top:6px;" onclick="jQuery(\'#avPermissionList\').toggle(\'medium\')">' . __(
            ...
            <tr>
                ...
                <td width="<?php echo $td['right']; ?>" valign="top">
                    <input type="checkbox" <?php echo(get_option("tornevall_dnsbl_prefer_api") ? "checked" : ""); ?>
                           value="1"
                           name="tornevall_dnsbl_prefer_api"> <?php echo __(
            ...
            <tr>
                ...
                <td width="<?php echo $td['right']; ?>" valign="top">
                    <input type="checkbox" <?php echo(get_option("tornevall_dnsbl_getlisted_resolver") ? "checked" : ""); ?>
                           value="1"
                           name="tornevall_dnsbl_getlisted_resolver"> <?php echo __(
